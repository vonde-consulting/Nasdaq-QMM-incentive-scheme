...
ticks={'AAPL','CSCO','EBAY','FB','GOOG','INTC','MSFT','YHOO'};
...
file=[mypath 'Data/SummaryStats/MPIDSub/' type '_' num2str(w) 'sec.xlsx'];
...
xlswrite([mypath  'Data/SummaryStats/MPIDSub/'  filename],table,['Sheet' num2str(y)])

intervals=unique(intervals);

labels={'9:45:00','11:00:00','12:30:00','14:30:00','16:00:00'};

q1=find(intervals==9.75*60*60); test1=isempty(q1);
...
set(gcf, 'PaperPositionMode', 'manual');
set(gcf, 'PaperPosition',[0 0 pos(3)+ti(1)+ti(3) pos(4)+ti(2)+ti(4)]);
saveas(hh,[mypath  'Data/SummaryStats/MPIDSub/'  temp 'Submission_Daily_ByFirm_' num2str(w) 'sec' '_' subset '.pdf']); 
