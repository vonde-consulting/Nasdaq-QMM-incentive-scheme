...
nms<-c("MPID.SUB.RATIO","MPID.SUB.BUY.RATIO","MPID.SUB.SELL.RATIO","RELSPR","RELEFFSPR.EXE.REP","RELRLZSPR.EXE.REP.PRE",
       "VOL.GRID.SHORT.PRE","VOL.SD","VOL.GRID.LONG.PRE","AGGR.REL.TOTAL","ORSZ.DVOL.TOTAL","AGGR.REL.TMBR",
...
vars<-c('TICK','TIMEPOINT','DAY','MPID.SUB.RATIO','MPID.SUB.BUY.RATIO','MPID.SUB.SELL.RATIO','SUB.ALL.NUM','SUB.BUY.NUM','SUB.SELL.NUM',
