...
for (jj in 26:numtests){
  ...
  if (jj==1){     
    ...
    reg1<-MPID.SUB.RATIO~lag(MPID.SUB.INST,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
    ...
    reg2<-SUB.ALL.NUM~lag(MPID.SUB.INST,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1:depvarlags)+lag(SUB.ALL.DVOL,k=1)+lag(EXE.ALL.DVOL,k=1)+
      lag(DEPTH.TOTAL.DVOL,k=1)+OPEN+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+lag(SUB.ALL.NUM.INST,k=1:mpidlags)
    
    model<-RELSPR~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1:depvarlags)+lag(SUB.ALL.DVOL,k=1)+lag(EXE.ALL.DVOL,k=1)+
      lag(DEPTH.TOTAL.DVOL,k=1)+OPEN+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
  ...
  if (jj==2){    
    ...
    reg1<-MPID.SUB.BUY.RATIO~lag(MPID.SUB.BUY.INST,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
    ...
    reg2<-SUB.BUY.NUM~lag(MPID.SUB.BUY.INST,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1:depvarlags)+lag(SUB.BUY.DVOL,k=1)+lag(EXE.BUY.DVOL,k=1)+
      lag(DEPTH.BUY.DVOL,k=1)+OPEN+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+lag(SUB.BUY.NUM.INST,k=1:mpidlags)
  ...
  if (jj==3){    
    ...
    reg1<-MPID.SUB.SELL.RATIO~lag(MPID.SUB.SELL.INST,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
    ...
    reg2<-SUB.SELL.NUM~lag(MPID.SUB.SELL.INST,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1:depvarlags)+lag(SUB.SELL.DVOL,k=1)+lag(EXE.SELL.DVOL,k=1)+
      lag(DEPTH.SELL.DVOL,k=1)+OPEN+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+lag(SUB.SELL.NUM.INST,k=1:mpidlags)
  ...
  if (jj==4){    
    ...
    model<-RELEFFSPR.EXE.REP~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELEFFSPR.EXE.REP,k=1:depvarlags)+lag(SUB.ALL.DVOL,k=1)+lag(EXE.ALL.DVOL,k=1)+
      lag(DEPTH.TOTAL.DVOL,k=1)+OPEN+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+lag(SUB.NUM.HAT,k=1:mpidlags)
  ...
  if (jj==5){     
    ...
    model<-RELRLZSPR.EXE.REP.POST~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELRLZSPR.EXE.REP.PRE,k=1:depvarlags)+lag(SUB.ALL.DVOL,k=1)+lag(EXE.ALL.DVOL,k=1)+
  ...
  if (jj==6){   
    ...
    model<-VOL.GRID.SHORT.POST~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1:depvarlags)+lag(RELSPR,k=1)+lag(SUB.ALL.DVOL,k=1)+lag(EXE.ALL.DVOL,k=1)+
      lag(DEPTH.TOTAL.DVOL,k=1)+OPEN+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+lag(SUB.NUM.HAT,k=1:mpidlags)
  ...
  if (jj==9){     
    ...
    model<-VOL.SD~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.SD,k=1:depvarlags)+lag(RELSPR,k=1)+lag(SUB.ALL.DVOL,k=1)+lag(EXE.ALL.DVOL,k=1)+
      lag(DEPTH.TOTAL.DVOL,k=1)+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+OPEN+lag(SUB.NUM.HAT,k=1:mpidlags)
  ...
  if (jj==10){     
    ...
    model<-VOL.GRID.LONG.POST~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.LONG.PRE,k=1:depvarlags)+lag(RELSPR,k=1)+lag(SUB.ALL.DVOL,k=1)+lag(EXE.ALL.DVOL,k=1)+
      lag(DEPTH.TOTAL.DVOL,k=1)+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+OPEN+lag(SUB.NUM.HAT,k=1:mpidlags)
  ...
  if (jj==11){     
    ...
    model<-SUB.ALL.DVOL~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.ALL.DVOL,k=1:depvarlags)+lag(EXE.ALL.DVOL,k=1)+
      lag(DEPTH.TOTAL.DVOL,k=1)+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+OPEN+lag(SUB.NUM.HAT,k=1:mpidlags)
  ...
  if (jj==12){    
    ...
    model<-SUB.BUY.DVOL~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.BUY.DVOL,k=1:depvarlags)+lag(EXE.BUY.DVOL,k=1)+
  ...
  if (jj==13){    
    ...
    model<-SUB.SELL.DVOL~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.SELL.DVOL,k=1:depvarlags)+lag(EXE.SELL.DVOL,k=1)+
      lag(DEPTH.SELL.DVOL,k=1)+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+OPEN+lag(SUB.NUM.HAT,k=1:mpidlags)
  ...
  if (jj==16){     
    ...
    model<-EXE.ALL.DVOL~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.ALL.DVOL,k=1)+lag(EXE.ALL.DVOL,k=1:depvarlags)+
      lag(DEPTH.TOTAL.DVOL,k=1)+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+OPEN+lag(SUB.NUM.HAT,k=1:mpidlags)
  ...
  if (jj==17){    
    ...
    model<-EXE.BUY.DVOL~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.BUY.DVOL,k=1)+lag(EXE.BUY.DVOL,k=1:depvarlags)+
      lag(DEPTH.BUY.DVOL,k=1)+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+OPEN+lag(SUB.NUM.HAT,k=1:mpidlags)
  ...
  if (jj==18){   
    ...
    model<-EXE.SELL.DVOL~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.SELL.DVOL,k=1)+lag(EXE.SELL.DVOL,k=1:depvarlags)+
      lag(DEPTH.SELL.DVOL,k=1)+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+OPEN+lag(SUB.NUM.HAT,k=1:mpidlags)
  ...
  if (jj==21){    
    ...
    model<-DEPTH.TOTAL.DVOL~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.ALL.DVOL,k=1)+lag(EXE.ALL.DVOL,k=1)+
  ...
  if (jj==22){    
    ...
    model<-DEPTH.BUY.DVOL~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.BUY.DVOL,k=1)+lag(EXE.BUY.DVOL,k=1)+
  ...
  if (jj==23){    
    ...
    model<-DEPTH.SELL.DVOL~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.SELL.DVOL,k=1)+lag(EXE.SELL.DVOL,k=1)+
  ...
  if (jj==25){    
    ...
    reg1<-MPID.SUB.RATIO~lag(MPID.SUB.BUY.INST,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.SELL.DVOL,k=1)+lag(EXE.SELL.DVOL,k=1)+
      lag(DEPTH.SELL.DVOL,k=1:depvarlags)+OPEN+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
...
##HASBROUCK
  if (jj==26){    
    ...
    model<-HASBROUCK.MAX~lag(MPID.SUB.HAT,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.ALL.DVOL,k=1)+lag(EXE.ALL.DVOL,k=1)+
      lag(DEPTH.TOTAL.DVOL,k=1)+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+OPEN+lag(SUB.NUM.HAT,k=1:mpidlags)+lag(HASBROUCK.MAX,k=1:depvarlags)
  ...
  if (jj==28){    
    ...
    reg2<-HASBROUCK.MAX~lag(MPID.SUB.SELL.INST,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
      lag(VOL.GRID.SHORT.PRE,k=1)+lag(RELSPR,k=1)+lag(SUB.SELL.DVOL,k=1)+lag(EXE.SELL.DVOL,k=1)+
      lag(DEPTH.SELL.DVOL,k=1)+OPEN+lag(abs(RELDPR.MID),k=1)+lag(NEG.DUMMY,k=1)+
      (lag(abs(RELDPR.MID),k=1)*lag(NEG.DUMMY,k=1))+lag(SUB.SELL.NUM.INST,k=1:mpidlags)+lag(HASBROUCK.MAX,k=1:depvarlags)
