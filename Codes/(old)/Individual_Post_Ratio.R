...
if(jj==2){
  l.relspr1<-depvarlags
  model<-RELSPR~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+OPEN+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+SUB.BUY.NUM|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  model2<-RELSPR~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+OPEN+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+SUB.BUY.NUM+DUMMIES|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
}

if(jj==3){
  l.relspr1<-depvarlags
  model<-RELSPR~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+OPEN+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+SUB.SELL.NUM|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  model2<-RELSPR~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+OPEN+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+SUB.SELL.NUM+DUMMIES|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  
}
if(jj==4){
  l.relspr2<-depvarlags
  model<-RELEFFSPR.EXE.REP~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.VOL.GRID.SHORT.PRE+LAG.RELEFFSPR.EXE.REP+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+OPEN+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+SUB.ALL.NUM|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
  model2<-RELEFFSPR.EXE.REP~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.VOL.GRID.SHORT.PRE+LAG.RELEFFSPR.EXE.REP+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+OPEN+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+SUB.ALL.NUM+DUMMIES|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
...
if(jj==7){
  l.vol1<-depvarlags
  model<-VOL.GRID.SHORT.POST~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+OPEN+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+SUB.BUY.NUM|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  model2<-VOL.GRID.SHORT.POST~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+OPEN+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+SUB.BUY.NUM+DUMMIES|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  
}
if(jj==8){
  l.vol1<-depvarlags
  model<-VOL.GRID.SHORT.POST~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
...
if(jj==9){
  l.vol2<-depvarlags
  model<-VOL.SD~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.SD+LAG.RELSPR+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.ALL.NUM|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
  model2<-VOL.SD~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.SD+LAG.RELSPR+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.ALL.NUM+DUMMIES|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
}

if(jj==10){
  l.vol3<-depvarlags
  model<-VOL.GRID.LONG.POST~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.LONG.PRE+LAG.RELSPR+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.ALL.NUM|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
  model2<-VOL.GRID.LONG.POST~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.LONG.PRE+LAG.RELSPR+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.ALL.NUM+DUMMIES|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
}
##SUBMISSIONVOLUME
if(jj==11){
  l.sub<-depvarlags
  model<-SUB.ALL.DVOL~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.ALL.NUM|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
  model2<-SUB.ALL.DVOL~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.ALL.NUM+DUMMIES|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
  
}
if(jj==12){
  l.sub.buy<-depvarlags
  model<-SUB.BUY.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  model2<-SUB.BUY.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM+DUMMIES|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  
}
if(jj==13){
  l.sub.sell<-depvarlags
  model<-SUB.SELL.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  model2<-SUB.SELL.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM+DUMMIES|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
}
if(jj==14){
  l.sub.buy<-depvarlags
  model<-SUB.BUY.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  model2<-SUB.BUY.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM+DUMMIES|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  
}
if(jj==15){
  l.sub.sell<-depvarlags
  model<-SUB.SELL.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  model2<-SUB.SELL.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM+DUMMIES|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  
}
##EXECUTIONVOLUME
if(jj==16){
  l.exe<-depvarlags
  model<-EXE.ALL.DVOL~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.ALL.NUM|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
  model2<-EXE.ALL.DVOL~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.ALL.NUM+DUMMIES|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
  
}
if(jj==17){
  l.exe.buy<-depvarlags
  model<-EXE.BUY.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  model2<-EXE.BUY.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM+DUMMIES|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  
}
if(jj==18){
  l.exe.sell<-depvarlags
  model<-EXE.SELL.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  model2<-EXE.SELL.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM+DUMMIES|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  
}
if(jj==19){
  l.exe.buy<-depvarlags
  model<-EXE.BUY.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  model2<-EXE.BUY.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM+DUMMIES|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  
}
if(jj==20){
  l.exe.sell<-depvarlags
  model<-EXE.SELL.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  model2<-EXE.SELL.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM+DUMMIES|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
} 
##DEPTH
if(jj==21){
  l.exe<-depvarlags
  model<-DEPTH.TOTAL.DVOL~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.ALL.NUM|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
  model2<-DEPTH.TOTAL.DVOL~LAG.MPID.SUB.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.ALL.DVOL+LAG.EXE.ALL.DVOL+LAG.DEPTH.TOTAL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.ALL.NUM+DUMMIES|.-LAG.MPID.SUB.RATIO+LAG.MPID.SUB.INST-SUB.ALL.NUM+SUB.ALL.NUM.INST
  
}
if(jj==22){
  l.d.buy<-depvarlags
  model<-DEPTH.BUY.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  model2<-DEPTH.BUY.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM+DUMMIES|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  
}
if(jj==23){
  l.d.sell<-depvarlags
  model<-DEPTH.SELL.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  model2<-DEPTH.SELL.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM+DUMMIES|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  
}
if(jj==24){
  l.d.buy<-depvarlags
  model<-DEPTH.BUY.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  model2<-DEPTH.BUY.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM+DUMMIES|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  
}
if(jj==25){
  l.d.sell<-depvarlags
  model<-DEPTH.SELL.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  model2<-DEPTH.SELL.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM+DUMMIES|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
} 
