...
filename<-paste(mypath,"/SummaryTable_RelSpr",w,"_sec_",jj,".txt",sep="")
...
filename<-paste(mypath,"/SummaryTable_Vol",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_Sub",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_Exe",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_Depth",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_HasbroucK_",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
