...
qq<-c('MPID.SUB','MPID.SUB.BUY','MPID.SUB.SELL',
                                'MPID.CANC','MPID.CANC.BUY','MPID.CANC.SELL',
                                'MPID.EXE','MPID.EXE.BUY','MPID.EXE.SELL')
...
vars<-c('TICK','TIMEPOINT','DAY','MPID.SUB','MPID.SUB.BUY','MPID.SUB.SELL','MPID.SUB.INST',
...
for (jj in 26:numtests){
  ...
  if (jj==1){     
    ...
    reg1<-MPID.SUB~lag(MPID.SUB.INST,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
  ...
  if (jj==2){    
    ...
    reg1<-MPID.SUB.BUY~lag(MPID.SUB.BUY.INST,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
  ...
  if (jj==3){    
    ...
    reg1<-MPID.SUB.SELL~lag(MPID.SUB.SELL.INST,k=c(1:mpidlags))+lag(AGGR.REL.TOTAL,k=1)+lag(ORSZ.DVOL.TOTAL,k=1)+lag(AGGR.REL.MPID,k=1)+lag(ORSZ.DVOL.MPID,k=1)+
