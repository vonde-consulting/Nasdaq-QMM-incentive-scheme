...
filename<-paste(mypath,"/SummaryTable_RelSpr_TMBR_",w,"_sec_",jj,".txt",sep="")
...
filename<-paste(mypath,"/SummaryTable_Vol_TMBR_",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_Sub_TMBR_",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_Exe_TMBR_",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_Depth_TMBR_",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_Hasbrouck_TMBR_",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
