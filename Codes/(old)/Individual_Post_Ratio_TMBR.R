...
folder<-"Individual_Post_Ratio_TMBR"
...
if(jj==14){
  model<-SUB.BUY.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  model2<-SUB.BUY.DVOL~LAG.MPID.SUB.SELL.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.BUY.DVOL+LAG.EXE.BUY.DVOL+LAG.DEPTH.BUY.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.BUY.NUM+DUMMIES|.-LAG.MPID.SUB.SELL.RATIO+LAG.MPID.SUB.SELL.INST-SUB.BUY.NUM+SUB.BUY.NUM.INST
  
}
if(jj==15){
  model<-SUB.SELL.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
  model2<-SUB.SELL.DVOL~LAG.MPID.SUB.BUY.RATIO+LAG.AGGR.REL.TOTAL+LAG.ORSZ.DVOL.TOTAL+LAG.AGGR.REL.MPID+LAG.ORSZ.DVOL.MPID+LAG.VOL.GRID.SHORT.PRE+LAG.RELSPR+LAG.SUB.SELL.DVOL+LAG.EXE.SELL.DVOL+LAG.DEPTH.SELL.DVOL+abs(LAG.RELDPR.MID)+LAG.NEG.DUMMY+(abs(LAG.RELDPR.MID)*LAG.NEG.DUMMY)+OPEN+SUB.SELL.NUM+DUMMIES|.-LAG.MPID.SUB.BUY.RATIO+LAG.MPID.SUB.BUY.INST-SUB.SELL.NUM+SUB.SELL.NUM.INST
