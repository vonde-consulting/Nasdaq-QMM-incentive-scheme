...
filename<-paste(mypath,"/SummaryTable_TMBR_RelSpr",w,"_sec_",jj,".txt",sep="")
...
filename<-paste(mypath,"/SummaryTable_TMBR_Vol",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_TMBR_Sub",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_TMBR_Exe",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_TMBR_Depth",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"/SummaryTable_TMBR_HasbroucK_",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
