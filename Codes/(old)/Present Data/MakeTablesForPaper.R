...
filename<-paste(mypath,"SummaryTables/SummaryTable_RelSpr",w,"_sec_",jj,".txt",sep="")
...
filename<-paste(mypath,"SummaryTables/SummaryTable_Vol",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"SummaryTables/SummaryTable_Sub",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"SummaryTables/SummaryTable_Exe",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"SummaryTables/SummaryTable_Depth",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"SummaryTables/SummaryTable_HasbroucK_",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
...
filename<-paste(mypath,"SummaryTables/SummaryTable_RelDPr_",w,"_sec_",jj,".txt",sep="")
cat(paste(sg, collapse = "\n"), "\n", file=filename, append=FALSE)
