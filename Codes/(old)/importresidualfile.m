function [raw] = importresidualfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14,VARNAME15] =
...
% Example:
%   [V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14,VarName15] =
%   importfile('RESIDUALS_BYFIRM_1MPIDLags_5DepVarLags_30sec_1.txt',2,
%   10916);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/05/27 16:00:07
