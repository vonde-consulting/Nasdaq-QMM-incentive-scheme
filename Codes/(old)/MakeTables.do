...
local filename "W:/TABLES/Table2"
...
local x MPID_SUB_RATIO
local filename "W:/TABLES/Table2a"
...
local x MPID_SUB_RATIO
local filename "W:/TABLES/Table2b"
...
local filename "W:/TABLES/Table3"
...
estat bgodfrey
outreg2 using `filename', tex tstat addstat(R2, e(r2), Breusch–Godfrey, r(dw)) addtext(Day FE, Yes, Lagged Dep. Var, YES) append

}

local filename "W:/TABLES/Table3a"
shell touch `filename'
...
local filename "W:/TABLES/Table3b"
shell touch `filename'
...
local filename "W:/TABLES/Table3c"
shell touch `filename'
...
local filename "W:/TABLES/Table3d"
shell touch `filename'
...
local filename "W:/TABLES/Table4"
...
local filename "W:/TABLES/Table5a"
shell touch `filename'
...
local filename "W:/TABLES/Table5b"
shell touch `filename'
...
local filename "W:/TABLES/Table5c"
shell touch `filename'
...
local filename "W:/TABLES/Table5d"
shell touch `filename'
...
***ALL SUBMISSIONS
qui ivreg2 `x' (MPID_SUB_RATIO SUB_ALL_NUM=INST_RATIO INST_SUB) L1.`x' L2.`x' L3.`x' L4.`x' L5.`x' L.RELSPR L.VOL_GRID_SHORT_PRE L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_BUY_DVOL L.EXE_BUY_DVOL  L.DEPTH_BUY_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13 if TICK==`y', partial(L1.`x' L2.`x' L3.`x' L4.`x' L5.`x' L.RELSPR L.VOL_GRID_SHORT_PRE L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_BUY_DVOL L.EXE_BUY_DVOL  L.DEPTH_BUY_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13) endog(MPID_SUB_RATIO SUB_ALL_NUM) robust first savefirst  
matrix F=e(first)
scalar F1=F[4,1]
scalar p1=F[7,1]
scalar F2=F[4,2]
...
***BUY SUBMISSIONS
qui ivreg2 `x' (MPID_BUY_RATIO SUB_BUY_NUM=INST_RATIO_BUY INST_SUB_BUY) L1.`x' L2.`x' L3.`x' L4.`x' L5.`x' L.RELSPR L.VOL_GRID_SHORT_PRE L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_BUY_DVOL L.EXE_BUY_DVOL  L.DEPTH_BUY_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13 if TICK==`y', partial(L1.`x' L2.`x' L3.`x' L4.`x' L5.`x' L.RELSPR L.VOL_GRID_SHORT_PRE L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_BUY_DVOL L.EXE_BUY_DVOL  L.DEPTH_BUY_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13) endog(MPID_BUY_RATIO SUB_BUY_NUM) robust first savefirst  
matrix F=e(first)
scalar F1=F[4,1]
scalar p1=F[7,1]
scalar F2=F[4,2]
...
local filename "W:/TABLES/`x'_PANEL"
shell touch `filename'
...
outreg2 using `filename', tex tstat addstat(Ftest1, F1, pval1, p1, Ftest2, F2, pval2, p2, Wu-Hausman, estat, p-val, estatp) addtext(Stock FE, YES, Day FE, NO) replace
...
outreg2 using `filename', tex tstat addstat(Wu-Hausman, estat, p-val, estatp) addtext(Stock FE, YES, Day FE, YES) append
