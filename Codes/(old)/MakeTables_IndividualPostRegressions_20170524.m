...
table=[table; cell(1,length(ticks)); table2];
rownames=[rownames;{''};{'ADF'};{'P.VAL'};{'KPSS'};{'P.VAL'};{'DW'};{'P.VAL'};{'TSTAT'};{'P.VAL'}];

savefilename=[mypath myfolder myfolder2 'SUMMARY_TABLE_' num2str(mpidlags) 'MPIDLags_' num2str(depvarlags) 'DepVarLags_' windows{w} 'sec_.xlsx'];
