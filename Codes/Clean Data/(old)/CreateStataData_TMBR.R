...
vars<-c('TICK','TIMEPOINT','DAY','TMBR.SUB','TMBR.SUB.BUY','TMBR.SUB.SELL','SUB.ALL.NUM','SUB.BUY.NUM','SUB.SELL.NUM',
        'TMBR.VOL.SUB','TMBR.VOL.SUB.BUY','TMBR.VOL.SUB.SELL',
        'TMBR.CANC','TMBR.CANC.BUY','TMBR.CANC.SELL','EXE.ALL.NUM','EXE.BUY.NUM','EXE.SELL.NUM',
        'TMBR.EXE','TMBR.EXE.BUY','TMBR.EXE.SELL','CANC.ALL.NUM','CANC.BUY.NUM','CANC.SELL.NUM',
...
filename<-paste(mypath,"DATA_TMBR_LEVELS_UNST_",w,"sec.dta",sep="")
