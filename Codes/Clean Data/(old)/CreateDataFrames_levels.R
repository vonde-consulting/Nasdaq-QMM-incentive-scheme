...
filename<-paste(mypath,"DATA_LEVELS_INST_NOAAPL_",w,"sec.Rds",sep="")
save(mydata_unst,mydata,file=filename)

filename<-paste(mypath,"DATA_LEVELS_INST_NOAAPL_",w,"sec.dta",sep="")
...
filename<-paste(mypath,"DATA_LEVELS_INST_",w,"sec.dta",sep="")
write.dta(mydata,file=filename) 
...
qq<-colnames(mydata)[which(colnames(mydata)%in%c('TMBR.SUB','TMBR.SUB.BUY','TMBR.SUB.SELL',
                                'TMBR.CANC','TMBR.CANC.BUY','TMBR.CANC.SELL',
                                'TMBR.EXE','TMBR.EXE.BUY','TMBR.EXE.SELL'))]
qq2<-c('SUB.ALL.NUM','SUB.BUY.NUM','SUB.SELL.NUM','CANC.ALL.NUM','CANC.BUY.NUM','CANC.SELL.NUM',
       'EXE.ALL.NUM','EXE.BUY.NUM','EXE.SELL.NUM')
...
filename<-paste(mypath,"DATA_TMBR_LEVELS_INST_NOAAPL_",w,"sec.Rds",sep="")
save(mydata_unst,mydata,file=filename)

filename<-paste(mypath,"DATA_TMBR_LEVELS_INST_",w,"sec.dta",sep="")
write.dta(mydata,file=filename) 
...
if (TRUE){
  ...
  qq<-c('TMBR.SUB','TMBR.SUB.BUY','TMBR.SUB.SELL',
                                  'TMBR.CANC','TMBR.CANC.BUY','TMBR.CANC.SELL',
                                  'TMBR.EXE','TMBR.EXE.BUY','TMBR.EXE.SELL')
  qq2<-c('SUB.ALL.NUM','SUB.BUY.NUM','SUB.SELL.NUM','CANC.ALL.NUM','CANC.BUY.NUM','CANC.SELL.NUM',
         'EXE.ALL.NUM','EXE.BUY.NUM','EXE.SELL.NUM')
