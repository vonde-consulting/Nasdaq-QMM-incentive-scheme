...
log using "W:/TABLES/Table11_2_Log_VOL", replace
...
***RELSPR***
local filename "W:/TABLES/Table11_Mills2_VOL_FULL_1_`p'p_`t't_`ssec'sec"
...
predict residuals if e(sample), e
	...
	scalar meanvec=meanvec[1,1]
	drop residuals
xtivreg2 VOL_GRID_SHORT_PRE (MPID_BUY_RATIO=INST_RATIO_BUY) L(1/`p').VOL_GRID_SHORT_PRE L.RELSPR L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_BUY_DVOL L.EXE_BUY_DVOL L.DEPTH_BUY_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13, partial(L(1/`p').VOL_GRID_SHORT_PRE L.RELSPR L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_BUY_DVOL L.EXE_BUY_DVOL L.DEPTH_BUY_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13) endog(MPID_BUY_RATIO) first savefirst fe robust cluster(TICK TIME)
matrix F=e(first)
scalar F1=F[4,1]
scalar p1=F[7,1]
capture confirm scalar e(estatp)
...
predict residuals if e(sample), e
	...
	scalar meanvec=meanvec[1,1]
	drop residuals
xtivreg2 VOL_GRID_SHORT_PRE (MPID_SELL_RATIO=INST_RATIO_SELL) L(1/`p').VOL_GRID_SHORT_PRE L.RELSPR L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_SELL_DVOL L.EXE_SELL_DVOL L.DEPTH_SELL_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13, partial(L(1/`p').VOL_GRID_SHORT_PRE L.RELSPR L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_SELL_DVOL L.EXE_SELL_DVOL L.DEPTH_SELL_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13) endog(MPID_SELL_RATIO) first savefirst fe robust cluster(TICK TIME)
matrix F=e(first)
scalar F1=F[4,1]
scalar p1=F[7,1]
capture confirm scalar e(estatp)
...
xtivreg2 VOL_GRID_SHORT_PRE (MPID_SUB=INST_LEVEL) L(1/`p').VOL_GRID_SHORT_PRE L.RELSPR L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_ALL_DVOL L.EXE_ALL_DVOL L.DEPTH_TOTAL_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13, endog(MPID_SUB) first savefirst fe robust cluster(TICK TIME)
predict residuals if e(sample), e
	matrix mat2=J(7,1,.)
	foreach z of num 2/8{
	qui wntestq2 residuals if TICK==`z',lag(`p')
...
xtreg VOL_GRID_SHORT_PRE L.MPID_DUM L.mills L(1/`p').VOL_GRID_SHORT_PRE L.RELSPR L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.RELDPR_MID L.SUB_ALL_DVOL L.EXE_ALL_DVOL L.DEPTH_TOTAL_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13, fe vce(cl TICK TIME) nonest
predict residuals if e(sample), e
	matrix mat2=J(8,1,.)
