...
log using "W:/TABLES/Table11_2_Log_DEPTHSELL", replace
...
foreach x of varlist RELSPR VOL* HASBROUCK_MAX AGGR_REL_MPID ORSZ_DVOL_MPID AGGR_REL_TMBR ORSZ_DVOL_TMBR RELDPR_MID SUB_BUY_DVOL DEPTH_SELL_DVOL DEPTH_SELL_DVOL SUB_BUY_DVOL DEPTH_SELL_DVOL DEPTH_SELL_DVOL SUB_BUY_DVOL DEPTH_SELL_DVOL DEPTH_SELL_DVOL MPID_SUB MPID_SUB_SELL MPID_SUB_BUY SUB_ALL_NUM SUB_BUY_NUM SUB_SELL_NUM CANC_ALL_DVOL CANC_BUY_DVOL CANC_SELL_DVOL {
sort TICK TIME
...
***RELSPR***
local filename "W:/TABLES/Table11_Mills2_DEPTHSELL_FULL_1_`p'p_`t't_`ssec'sec"
xtivreg2 DEPTH_SELL_DVOL (MPID_SUB_RATIO=INST_RATIO) L(1/`p').DEPTH_SELL_DVOL L.RELSPR L.VOL_GRID_SHORT_PRE L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_ALL_DVOL L.EXE_ALL_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13, endog(MPID_SUB_RATIO) first savefirst fe robust cluster(TICK TIME)
predict residuals if e(sample), e
	...
	drop residuals
xtivreg2 DEPTH_SELL_DVOL (MPID_SUB_RATIO=INST_RATIO) L(1/`p').DEPTH_SELL_DVOL L.RELSPR L.VOL_GRID_SHORT_PRE L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_ALL_DVOL L.EXE_ALL_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13, partial(L(1/`p').DEPTH_SELL_DVOL L.RELSPR L.VOL_GRID_SHORT_PRE L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.NEG_DUMMY L.RELDPR_MID L.RELDPR_NEG L.SUB_ALL_DVOL L.EXE_ALL_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13) endog(MPID_SUB_RATIO) first savefirst fe robust cluster(TICK TIME)
matrix F=e(first)
scalar F1=F[4,1]
scalar p1=F[7,1]
...
xtreg DEPTH_SELL_DVOL L.MPID_DUM L.mills L(1/`p').DEPTH_SELL_DVOL L.RELSPR L.VOL_GRID_SHORT_PRE L.HASBROUCK_MAX L.AGGR_REL_MPID L.ORSZ_DVOL_MPID L.RELDPR_MID L.SUB_BUY_DVOL L.EXE_BUY_DVOL OPEN dum1 dum2 dum3 dum4 dum5 dum6 dum7 dum8 dum9 dum10 dum11 dum12 dum13, fe vce(cl TICK TIME) nonest
predict residuals if e(sample), e
	matrix mat2=J(8,1,.)
